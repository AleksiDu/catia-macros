...
' Set formula1 = relations1.CreateFormula("Formula.1", "", intParam1, "`" & product1.PartNumber & "\Part Number` ->Extract(0,Search_result)")
...
'     'Nothing
' else
' Set strParam2 = parameters3.CreateInteger("","")
...
' On Error Resume Next
' Err.Clear
' Set strParam11 = product1.UserRefProperties.Item("Part_Number")
' if Err.Number = 0 then
